...
class Hal(ContinualLearner):
    ...
    def __init__(
        ...
        self.spare_opt = SGD(self.spare_model.parameters(), lr=0.1)
    ...
    def get_anchors(self, task_id, train_data_regime):
        ...
        theta_m = self.spare_model.state_dict()
        ...
        for a_class in classes_for_this_task:
            ...
            for i in range(self.anchor_optimization_steps):
                ...
                loss = torch.sum(
                    self.gamma
                    * (self.spare_model.forward_features(e_t) - self.phi[:2]) ** 2
                )
    ...
    def train_one_step(self, x, y, meters, step):
        ...
        old_weights = self.backbone.state_dict()
        ...
        with get_timer(
            ...
            if len(self.anchors) > 0:
                ...
                self.backbone.load_state_dict(old_weights)
                pred_anchors -= self.backbone(self.anchors)
